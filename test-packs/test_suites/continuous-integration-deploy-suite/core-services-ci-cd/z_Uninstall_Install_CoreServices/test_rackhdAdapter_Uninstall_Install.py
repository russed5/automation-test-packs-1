...
def test_sysdef_uninstall(setup):
    """
    Title: Verify the dell-cpsd-hal-rackhd-adapter service can be uninstalled
    Description: This test verifies that the dell-cpsd-hal-rackhd-adapter service can be uninstalled successfully
...
def test_sysdef_serviceup(setup):
    """
    Title: Verify the dell-cpsd-hal-rackhd-adapter service containers are UP
    Description: This test verifies that the dell-cpsd-hal-rackhd-adapter container is up
    Params: dell-cpsd-hal-rackhd-adapter
    Returns: None
