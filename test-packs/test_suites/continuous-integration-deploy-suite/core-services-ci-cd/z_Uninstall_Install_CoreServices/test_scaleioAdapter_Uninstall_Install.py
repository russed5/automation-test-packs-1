...
def test_sysdef_uninstall(setup):
    """
    Title: Verify the dell-cpsd-hal-scaleio-adapter service can be uninstalled
    Description: This test verifies that the ddell-cpsd-hal-scaleio-adapter service can be uninstalled successfully
    Params: dell-cpsd-hal-scaleio-adapter
    Returns: None

    """
    service = "dell-cpsd-hal-scaleio-adapter"
...
def test_sysdef_install(setup):
    ...
    """
    Title: Verify the dell-cpsd-hal-scaleio-adapterr service can be installed
    Description: This test verifies that the dell-cpsd-hal-scaleio-adapter service can be installed successfully
    Params: dell-cpsd-hal-scaleio-adapter
    Returns: None
...
def test_sysdef_serviceup(setup):
    """
    Title: Verify the dell-cpsd-hal-scaleio-adapter service containers are UP
    Description: This test verifies that the ddell-cpsd-hal-scaleio-adapter container is up
    Params: dell-cpsd-hal-scaleio-adapter
    Returns: None
