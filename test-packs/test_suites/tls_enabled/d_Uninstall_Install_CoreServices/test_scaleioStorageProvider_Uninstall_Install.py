...
def test_sysdef_uninstall(setup):
    """
    Title: Verify the dell-cpsd-hdp-scaleio-storage-provider service can be uninstalled
    Description: This test verifies that the dell-cpsd-hdp-scaleio-storage-provider service can be uninstalled successfully
    Params: dell-cpsd-hdp-scaleio-storage-provider:
    Returns: None

    """
    service = "dell-cpsd-hdp-scaleio-storage-provider"
...
def test_sysdef_install(setup):
    ...
    """
    Title: Verify the dell-cpsd-hdp-scaleio-storage-provider service can be installed
    Description: This test verifies that the dell-cpsd-hdp-scaleio-storage-provider service can be installed successfully
    Params: dell-cpsd-hdp-scaleio-storage-provider:
    Returns: None
...
def test_sysdef_serviceup(setup):
    """
    Title: Verify the dell-cpsd-hdp-scaleio-storage-provider service containers are UP
    Description: This test verifies that the dell-cpsd-hdp-scaleio-storage-provider container is up
    Params: dell-cpsd-hdp-scaleio-storage-provider:
    Returns: None
